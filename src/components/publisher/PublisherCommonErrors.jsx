...
class PublisherCommonErrors extends Component {
  ...
  loadData(state, props){
    ...
    const query = `datasets/aggregations/?format=json&group_by=model&aggregations=note_count&order_by=-note_count&publisher_id=${props.publisher}`
  ...
  render () {
    ...
    return (
      <Card id="publisher-common-error-list-table" tableCard>
        ...
        <DataTable plain>
          <Header sortValue={ordering} sort={this.sort} publisher={this.props.publisher}></Header>
          <TableBody>
            {rows}
          </TableBody>
...
PublisherCommonErrors.contextTypes = {
...
export default PublisherCommonErrors